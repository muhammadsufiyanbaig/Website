...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        <div className="bg-[#b302029d] absolute top-0 -z-50 right-0 h-80 w-60 rounded-full blur-[25rem] dark:blur-[15rem] sm:w-[68.75rem] dark:bg-[#711400]"></div>
        <ThemeContextProvider>
          <ActiveSectionContextProvider>
            <Header />
            {children}
            <Footer />
            <div className="bg-[#b302029d] absolute bottom-0 -z-50 left-0 h-80 w-60 rounded-full blur-[25rem] dark:blur-[30rem] sm:w-[68.75rem] dark:bg-[#711500]"></div>
